            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavId">
                    ...
                    <div class="dropdown d-sm-none">
                        <button type="button" class="btn btn-outline-warning my-2" onclick="location.href='https://kengboonang.github.io/WADBrothers.github.io/templates/pages/signup_login%20pages/login_page.html'" @click.native="sign_out()">Sign Out</button>
                    </div>
                </div>
